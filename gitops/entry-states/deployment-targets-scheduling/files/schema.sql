-- claims-db schema for the deployment-targets-scheduling SOLVE/end state — captured from parasol-claims:1.1's own Hibernate
...
-- schema-management=none: a rolling-update pod boot no longer drops+reseeds the shared DB (the deployment-targets-scheduling
