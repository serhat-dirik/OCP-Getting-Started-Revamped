...
{{- define "m22.namespace" -}}{{ .Values.user }}-modernize{{- end -}}
...
{{- define "m22.legacyRepoUrl" -}}https://gitea-{{ .Values.giteaNamespace }}.{{ .Values.clusterDomain }}/{{ .Values.user }}/{{ .Values.forkRepo }}{{- end -}}
