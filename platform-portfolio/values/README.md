...
| `workshop-user-creds` Secret (ns `gitea`, key `password`) — shared attendee password for Gitea account seeding | workshop-config Gitea user-seed Job | `bootstrap/install.sh` |
