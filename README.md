...
| D | M24 | Agentic AI on OpenShift | Ask a running AI agent questions about live claims and policies, and watch grounding depend on how you phrase the question. Inspect the MCP tools it calls, ground an answer in policy documents with RAG, and read its token, latency, and tool-call metrics. | ~4-6 min | 50 min |
