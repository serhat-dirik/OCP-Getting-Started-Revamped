...
Visual: Reuse concept diagram jobs-batch-kueue-...-01-async-spectrum.svg — request → event → batch, batch highlighted.
...
Visual: Reuse concept diagram jobs-batch-kueue-...-02-kueue-admission.svg — Job → LocalQueue → ClusterQueue → admitted / pending / preempted.
