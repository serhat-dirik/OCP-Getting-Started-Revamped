...
-- which loads each event by id in a loop (a DELIBERATE N+1 for the observability-health-scale
-- tracing lab - see ClaimResource.history). Ids are FIXED and seed-controlled. CLM-1001 has the
