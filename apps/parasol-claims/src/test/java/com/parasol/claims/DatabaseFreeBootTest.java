 ...
 * without contacting a database at all. Three entry states depend on it — the
 * resilience-multicluster-dr per-site responder, the modernization module's deployed service,
 * and the AI-assisted module's seeded deployment — and in two of them a pod that crash-loops
 * for a database reason would be mistaken for the probe fault the lab is actually about.
 *
...
class DatabaseFreeBootTest {
    ...
    /** What the resilience / modernization Deployments set, spelled as Quarkus config keys. */
